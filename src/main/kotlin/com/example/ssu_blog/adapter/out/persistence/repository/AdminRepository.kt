...
import com.example.ssu_blog.adapter.out.persistence.entity.QUserEntity
...
class AdminRepositoryImpl(
    ...
    override fun findAllUser(
        ...
        createdAtEnd: LocalDateTime?,
        updatedAtStart: LocalDateTime?,
        updatedAtEnd: LocalDateTime?): List<UserEntity> {
        val user = QUserEntity.userEntity
        val query = jpaQueryFactory.selectFrom(QUserEntity.userEntity)
