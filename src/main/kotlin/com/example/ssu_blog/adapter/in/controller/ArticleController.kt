...
class ArticleController(
    ...
    @Operation(summary = "게시글 등록", description = "게시글 제목과 본문을 받아 게시글 등록", tags = ["게시글 Api"],
        responses = [
            ApiResponse(responseCode = "200", description = "게시글 등록 성공", content = [Content(schema = Schema(implementation = ArticleCreateOrUpdateResponse::class))]),
            ApiResponse(responseCode = "404", description = "잘못 된 접근", content = [Content(schema = Schema(implementation = ExceptionResponse::class))])
        ])
    @ResponseBody
    @PostMapping("")
    ...
    @Operation(summary = "게시글 수정", description = "변경 될 게시글 제목과 본문을 받아 Path로 들어온 게시글 수정", tags = ["게시글 Api"],
        responses = [
            ApiResponse(responseCode = "200", description = "게시글 수정 성공", content = [Content(schema = Schema(implementation = ArticleCreateOrUpdateResponse::class))]),
            ApiResponse(responseCode = "404", description = "게시글이 존재하지 않거나 잘못 된 접근", content = [Content(schema = Schema(implementation = ExceptionResponse::class))]),
            ApiResponse(responseCode = "403", description = "게시글을 수정 할 권한이 없음", content = [Content(schema = Schema(implementation = ExceptionResponse::class))])
        ])
    @ResponseBody
    ...
    @Operation(summary = "게시글 삭제", description = "Path로 들어온 게시글 삭제", tags = ["게시글 Api"],
        responses = [
            ApiResponse(responseCode = "200", description = "게시글 수정 성공", content = [Content(schema = Schema(implementation = ArticleCreateOrUpdateResponse::class))]),
            ApiResponse(responseCode = "404", description = "게시글이 존재하지 않거나 잘못 된 접근", content = [Content(schema = Schema(implementation = ExceptionResponse::class))]),
            ApiResponse(responseCode = "403", description = "게시글을 삭제 할 권한이 없음", content = [Content(schema = Schema(implementation = ExceptionResponse::class))])
        ])
    @ResponseBody
