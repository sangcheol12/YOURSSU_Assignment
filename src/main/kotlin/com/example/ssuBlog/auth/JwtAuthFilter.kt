...
import com.example.ssuBlog.Exception.BadRequestCode
import com.example.ssuBlog.Exception.CustomBadRequestException
    ...
    override fun doFilterInternal(
        ...
        if (accessToken != null) {
            if (jwtTokenProvider.validateAccessToken(accessToken)) {
                ...
                throw CustomBadRequestException(BadRequestCode.INVALID_TOKEN) // 유효하지 않는 토큰
            }
        } else {
